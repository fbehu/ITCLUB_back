...
class GroupsViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['post'], url_path='students', permission_classes=[IsAuthenticated, IsAdmin])
    def students(self, request, pk=None):
        """
        Add students to the group.
        Expected body: {"student_ids": ["uuid1", "uuid2", ...]}
        Returns summary: added_count, added_ids, missing_ids
        """
